    ...
    public class GiresunOptano : EczaneNobetKisit, IEczaneNobetGiresunOptimization
    {
        ...
        private Model Model(GiresunDataModel data)
        {
            ...
            if (nobetGrupGorevTip != null)
            {
                ...
                var gruptakiEczaneSayisiIstisnalarHaric = eczaneNobetGruplar.Count - 5;
                ...
                var ortalamaNobetSayisiKumulatifCuma = OrtalamaNobetSayisi(talepEdilenNobetciSayisiCuma + kumulatifToplamNobetSayisiCuma, gruptakiEczaneSayisi - 4);
                ...
                foreach (var eczaneNobetGrup in eczaneNobetGruplar)
                {
                    ...
                    var yazilabilecekIlkCumartesiTarihi = eczaneNobetIstatistik.SonNobetTarihiCumartesi.AddDays(cumartesiGunAraligi);//.AddMonths(cumartersiNobetiYazilabilecekIlkAy - 1);
