...
{
    public class Alanya2021Optano : EczaneNobetKisit, IEczaneNobetAlanya2021OptimizationV2
    {
        ...
        private Model Model(Alanya2021DataModel data)
        {
            var model = new Model() { Name = "Alanya2021 Eczane Nöbet" };
        ...
        public EczaneNobetSonucModel Solve(Alanya2021DataModel data)
        {
