...
{
    public class DiyarbakirOptano : EczaneNobetKisit, IEczaneNobetDiyarbakirOptimization
    {
        ...
        private Model Model(DiyarbakirDataModel data)
        {
            var model = new Model() { Name = "Diyarbakir Eczane Nöbet" };
            ...
            foreach (var nobetGrupGorevTip in data.NobetGrupGorevTipler)
            {
                ...
                var ortalamaNobetSayisiKumulatifHaftaIciKalibrasyonlu = OrtalamaNobetSayisi(talepEdilenNobetciSayisiHaftaIci
                    ...
                    .Where(w => w.NobetUstGrupId == data.NobetUstGrupId
        ...
        public EczaneNobetSonucModel Solve(DiyarbakirDataModel data)
        {
