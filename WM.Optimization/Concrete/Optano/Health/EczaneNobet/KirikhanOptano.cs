...
{
    public class KirikhanOptano : EczaneNobetKisit, IEczaneNobetKirikhanOptimization
    {
        ...
        private Model Model(KirikhanDataModel data)
        {
            ...
            var yazBaslangic = new DateTime(data.BaslangicTarihi.Year, 6, 1);
            var yazBitis = new DateTime(data.BaslangicTarihi.Year, 9, 15);
            ...
            if (nobetGrupGorevTip != null)
            {
                ...
                var pespeseNobetSayisiHaftaSonu = (int)GetNobetGunKural(nobetGrupKurallar, 8);
                ...
                //if (YazDonemiMi(data.BaslangicTarihi, yazBaslangic, yazBitis))
                //{
                //    tarihler = tarihler.Where(w => !cumartesiGunleri.Select(s => s.TakvimId).Contains(w.TakvimId)).ToList();
                //    cumartesiGunleri = new List<TakvimNobetGrup>();
                //    cumartesiVePazarGunleri = new List<TakvimNobetGrup>();
                //    //pazarGunleri = new List<TakvimNobetGrup>();
                //}

                var tarihlerTumGorevTipleri = data.TarihAraligi;
                var cumartesiTumGorevTipleri = data.TarihAraligi.Where(w => w.NobetGunKuralId == 7).ToList();
                var cumartesiYazGorevTipleri = data.TarihAraligi.Where(w => w.NobetGunKuralId == 7 && w.NobetGorevTipId == 13).ToList();

                var cumartesiYazveBayramlar = cumartesiYazGorevTipleri.Union(bayramlar).ToList();
                #endregion
                ...
                var gruptakiEczaneSayisiIstisnalarHaric = eczaneNobetGruplar.Count - 0;
                ...
                var eczaneNobetGrupGunKuralIstatistiklerSon3AyTumu = data.EczaneNobetGrupGunKuralIstatistikYataySon3Ay;
                ...
                //hafta içi                
                var altLimitHaftaIci = GetArdisikBosGunSayisi(pespeseNobetSayisiHaftaIci, altLimit);
                var altLimitHaftaSonu = GetArdisikBosGunSayisi(pespeseNobetSayisiHaftaSonu, altLimit) / 2;
                ...
                var talepEdilenNobetciSayisiTumu = data.TarihAraligi.Sum(s => s.TalepEdilenNobetciSayisi);
                ...
                var talepEdilenNobetciSayisiCumartesiYaz = cumartesiYazGorevTipleri.Sum(s => s.TalepEdilenNobetciSayisi);
                var talepEdilenNobetciSayisiPazar = pazarGunleri.Sum(s => s.TalepEdilenNobetciSayisi);
                var talepEdilenNobetciSayisiBayramlar = bayramlar.Sum(s => s.TalepEdilenNobetciSayisi);
                ...
                var ortalamaNobetSayisiBayram = OrtalamaNobetSayisi(talepEdilenNobetciSayisiBayramlar, gruptakiEczaneSayisiIstisnalarHaric);
                ...
                var kumulatifToplamNobetSayisiCumartesi = eczaneNobetGrupGunKuralIstatistiklerTumGorevTipleri
                    .Where(w => w.NobetGorevTipId == nobetGrupGorevTip.NobetGorevTipId).Sum(s => s.NobetSayisiCumartesi);

                var kumulatifToplamNobetSayisiBayram = eczaneNobetGrupGunKuralIstatistiklerTumGorevTipleri.Sum(s => s.NobetSayisiBayram);
                var kumulatifToplamNobetSayisiCumartesiYaz = eczaneNobetGrupGunKuralIstatistiklerTumGorevTipleri
                    .Where(w => w.NobetGorevTipId == 13).Sum(s => s.NobetSayisiCumartesi);
                ...
                var kumulatifToplamNobetSayisiSon3AyTumu = eczaneNobetGrupGunKuralIstatistiklerSon3AyTumu.Sum(s => s.NobetSayisiToplam);
                ...
                var ortalamaNobetSayisiKumulatifTumu = OrtalamaNobetSayisi(talepEdilenNobetciSayisiTumu + kumulatifToplamNobetSayisi, gruptakiEczaneSayisiIstisnalarHaric);//gruptakiEczaneSayisi
                ...
                var ortalamaNobetSayisiKumulatifCumartesiYazveBayramTumu = OrtalamaNobetSayisi(talepEdilenNobetciSayisiCumartesiYaz + talepEdilenNobetciSayisiBayramlar
                                                                            + kumulatifToplamNobetSayisiCumartesiYaz + kumulatifToplamNobetSayisiBayram, gruptakiEczaneSayisi);
                ...
                var ortalamaNobetSayisiKumulatifCtsvePazar = OrtalamaNobetSayisi(talepEdilenNobetciSayisiCumartesi
                    + talepEdilenNobetciSayisiPazar
                    + kumulatifToplamNobetSayisiCumartesi
                    + kumulatifToplamNobetSayisiPazar,
                    gruptakiEczaneSayisi);

                var ortalamaNobetSayisiKumulatifSon3Ay = OrtalamaNobetSayisi(talepEdilenNobetciSayisi + kumulatifToplamNobetSayisiSon3AyTumu, gruptakiEczaneSayisi);
                var ortalamaNobetSayisiKumulatifSon3AyTumu = OrtalamaNobetSayisi(talepEdilenNobetciSayisi + kumulatifToplamNobetSayisiSon3Ay, gruptakiEczaneSayisi);
                ...
                foreach (var eczaneNobetGrup in eczaneNobetGruplar)
                {
                    ...
                    var eczaneNobetIstatistikSon3AyTumu = eczaneNobetGrupGunKuralIstatistiklerSon3Ay
                    ...
                    var eczaneBazliGunKuralIstatistikYatay = data.EczaneBazliGunKuralIstatistikYatay
                            .Where(w => w.EczaneId == eczaneNobetGrup.EczaneId
                                     && w.NobetGorevTipId == nobetGrupGorevTip.NobetGorevTipId).SingleOrDefault() ?? new EczaneNobetGrupGunKuralIstatistikYatay();

                    var eczaneBazliGunKuralIstatistikYatayYazCtesi = data.EczaneBazliGunKuralIstatistikYatay
                            .Where(w => w.EczaneId == eczaneNobetGrup.EczaneId
                                     && w.NobetGorevTipId == 13).SingleOrDefault() ?? new EczaneNobetGrupGunKuralIstatistikYatay();
                    ...
                    var yazilabilecekIlkHaftaIciTarihi = eczaneNobetIstatistik.SonNobetTarihiHaftaIci.AddDays(altLimitHaftaIci);
                    var yazilabilecekIlkHaftaSonuTarihi = eczaneNobetIstatistik.SonNobetTarihiHaftaSonu.AddDays(altLimitHaftaSonu * 7);
                    ...
                    var kpHerAyHaftaSonuPespeseGorev = new KpHerAyHaftaIciPespeseGorev
                    {
                        Model = model,
                        Tarihler = cumartesiVePazarGunleri,
                    ...
                    HerAyHaftaIciPespeseGorev(kpHerAyHaftaSonuPespeseGorev);
                    ...
                    var pesPeseGorevEnAzHaftaSonu = (KpPesPeseGorevEnAz)pesPeseGorevEnAzBase.Clone();

                    pesPeseGorevEnAzHaftaSonu.NobetSayisi = eczaneNobetIstatistik.NobetSayisiHaftaSonu;
                    pesPeseGorevEnAzHaftaSonu.NobetUstGrupKisit = NobetUstGrupKisit(kisitlarAktif, "k86");
                    pesPeseGorevEnAzHaftaSonu.Tarihler = cumartesiVePazarGunleri;
                    pesPeseGorevEnAzHaftaSonu.NobetYazilabilecekIlkTarih = yazilabilecekIlkHaftaSonuTarihi;
                    pesPeseGorevEnAzHaftaSonu.SonNobetTarihi = eczaneNobetIstatistik.SonNobetTarihiHaftaSonu;

                    PesPeseGorevEnAz(pesPeseGorevEnAzHaftaSonu);
                    ...
                    kpKumulatifToplamCumartesiEnFazlaTumGorevTipleri.NobetUstGrupKisit = NobetUstGrupKisit(kisitlarAktif, "k21");
                    ...
                    var kpKumulatifToplamEnFazlaTumGorevTipleriYazCtesiBayram = (KpKumulatifToplam)kpKumulatifToplam.Clone();

                    kpKumulatifToplamEnFazlaTumGorevTipleriYazCtesiBayram.EczaneNobetTarihAralik = eczaneNobetTarihAralikEczaneBazliTumGrorevTipler;
                    kpKumulatifToplamEnFazlaTumGorevTipleriYazCtesiBayram.Tarihler = cumartesiYazveBayramlar;
                    kpKumulatifToplamEnFazlaTumGorevTipleriYazCtesiBayram.NobetUstGrupKisit = NobetUstGrupKisit(kisitlarAktif, "k87");
                    kpKumulatifToplamEnFazlaTumGorevTipleriYazCtesiBayram.ToplamNobetSayisi = eczaneBazliGunKuralIstatistikYatayYazCtesi.NobetSayisiCumartesi
                                                                                       + eczaneBazliGunKuralIstatistikYatay.NobetSayisiBayram;

                    kpKumulatifToplamEnFazlaTumGorevTipleriYazCtesiBayram.KumulatifOrtalamaNobetSayisi = ortalamaNobetSayisiKumulatifCumartesiYazveBayramTumu;
                    //kpKumulatifToplamCumartesiEnFazlaTumGorevTipleri.GunKuralAdi = "Yaz Cts. ve Bayramlar";

                    KumulatifToplamEnFazla(kpKumulatifToplamEnFazlaTumGorevTipleriYazCtesiBayram);
                    ...
                    kpKumulatifToplamEnFazlaSon3Ay.Tarihler = tarihlerTumGorevTipleri;
                    kpKumulatifToplamEnFazlaSon3Ay.NobetUstGrupKisit = NobetUstGrupKisit(kisitlarAktif, "k68");
                    kpKumulatifToplamEnFazlaSon3Ay.ToplamNobetSayisi = eczaneNobetIstatistikSon3AyTumu.NobetSayisiToplam;
                    kpKumulatifToplamEnFazlaSon3Ay.KumulatifOrtalamaNobetSayisi = ortalamaNobetSayisiKumulatifSon3AyTumu;
                    ...
                    kpKumulatifToplamEnFazlaCumartesiVePazar.KumulatifOrtalamaNobetSayisi = ortalamaNobetSayisiKumulatifCtsvePazar;
            ...
            if (nobetGrupGorevTip != null && YazDonemiMi(data.BaslangicTarihi, yazBaslangic, yazBitis))
            {
                #region kısıtlar grup bazlı
                ...
                var eczaneNobetTarihAralikGrupBazli = data.EczaneNobetTarihAralik
                   .Where(e => e.NobetGorevTipId == nobetGrupGorevTip.NobetGorevTipId
                            && e.NobetGrupId == nobetGrupGorevTip.NobetGrupId
                            && (e.Tarih >= yazBaslangic && e.Tarih <= yazBitis)
                            ).ToList();
        ...
        private bool YazDonemiMi(DateTime tarih, DateTime yazBaslangic, DateTime yazBitis)
        {
            return tarih >= yazBaslangic && tarih <= yazBitis;
        }

        public EczaneNobetSonucModel Solve(KirikhanDataModel data)
        {
