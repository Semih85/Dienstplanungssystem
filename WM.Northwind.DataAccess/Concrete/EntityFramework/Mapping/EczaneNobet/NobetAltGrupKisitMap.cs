...
{
    public class NobetAltGrupKisitMap : EntityTypeConfiguration<NobetAltGrupKisit>
    {
        public NobetAltGrupKisitMap()
        {
            this.HasKey(t => t.Id);
            this.ToTable("NobetAltGrupKisitlar");
            ...
            this.HasRequired(t => t.NobetAltGrup)
                        .WithMany(et => et.NobetAltGrupKisitlar)
