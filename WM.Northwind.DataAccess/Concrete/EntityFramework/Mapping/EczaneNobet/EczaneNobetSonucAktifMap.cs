...
{
    public class EczaneNobetSonucAktifMap : EntityTypeConfiguration<EczaneNobetSonucAktif>
    {
        public EczaneNobetSonucAktifMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);

            // Table & Column Mappings
            this.ToTable("EczaneNobetSonucAktifler");
            ...
            this.Property(t => t.EczaneNobetGrupId)
                ...
                .HasColumnAnnotation("Index",
                    new IndexAnnotation(
                        new IndexAttribute("UN_EczaneNobetSonucAktifler")
                        {
                            IsUnique = true,
                            Order = 1
                        }));
            ...
            this.HasRequired(t => t.EczaneNobetGrup)
                .WithMany(et => et.EczaneNobetSonucAktifler)
