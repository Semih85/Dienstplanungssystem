...
{
    public class DebugEczaneMap : EntityTypeConfiguration<DebugEczane>
    {
        public DebugEczaneMap()
        {
            this.HasKey(t => t.Id);
            this.ToTable("DebugEczaneler");
            ...
            this.Property(t => t.EczaneNobetGrupId).IsRequired()
                        .HasColumnAnnotation("Index",
                         new IndexAnnotation(
                                     new IndexAttribute("UN_DebugEczaneler")
                                      {
                                                  IsUnique = true,
                                                  Order = 1
                                      }));
