...
{
    public class ZonguldakOptimizationManager : IZonguldakOptimizationService
    {
        #region ctor
        private IEczaneGrupService _eczaneGrupService;
        private IEczaneGrupTanimService _eczaneGrupTanimService;
        private IEczaneNobetZonguldakOptimization _eczaneNobetZonguldakOptimization;
        ...
        public ZonguldakOptimizationManager(
                    IEczaneGrupService eczaneGrupService,
                    IEczaneGrupTanimService eczaneGrupTanimService,
                    IEczaneNobetZonguldakOptimization eczaneNobetZonguldakOptimization,
            ...
            )
        {
            ...
            _eczaneNobetZonguldakOptimization = eczaneNobetZonguldakOptimization;
        ...
        public EczaneNobetSonucModel EczaneNobetCozAktifiGuncelle(ZonguldakDataModel data)
        {
            ...
            var yeniSonuclar = _eczaneNobetZonguldakOptimization.Solve(data);
        ...
        public EczaneNobetSonucModel EczaneNobetCozSonuclaraEkle(ZonguldakDataModel data)
        {
            var yeniSonuclar = _eczaneNobetZonguldakOptimization.Solve(data);
        ...
        private ZonguldakDataModel EczaneNobetDataModel(EczaneNobetDataModelParametre eczaneNobetDataModelParametre)
        {
            ...
            {
                var haftaIciAnahtarListeTumEczaneler = _takvimService.AnahtarListeyiBuGuneTasi(nobetGrupIdListe, nobetGorevTipId, nobetUstGrupBaslangicTarihi, eczaneNobetGruplarTumu, eczaneNobetGrupGunKuralIstatistikYatay, anahtarListe, gunGrup.GunGrupAdi);
