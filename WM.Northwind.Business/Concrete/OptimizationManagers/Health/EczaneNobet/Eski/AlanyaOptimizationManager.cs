    ...
    public class AlanyaOptimizationManager : IAlanyaOptimizationService
    {
        ...
        private AlanyaDataModel EczaneNobetDataModel(EczaneNobetDataModelParametre eczaneNobetDataModelParametre)
        {
            ...
            var alanyaDataModel = new AlanyaDataModel()
            {
                ...
                EczaneNobetTarihAralik = _takvimService.GetEczaneNobetTarihAralik(yilBitis, ayBitis, nobetGorevTipId, nobetGrupIdListe), //karar değişkeni
                ...
                TarihAraligi = _takvimService.GetTakvimNobetGruplar(yilBitis, ayBitis, nobetGrupIdListe, nobetGorevTipId),
