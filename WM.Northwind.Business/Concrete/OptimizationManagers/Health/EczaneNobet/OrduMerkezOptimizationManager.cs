...
{
    public class OrduMerkezOptimizationManager : IOrduMerkezOptimizationService
    {
        #region ctor
        private IEczaneGrupService _eczaneGrupService;
        private IEczaneGrupTanimService _eczaneGrupTanimService;
        private IEczaneNobetOrduMerkezOptimization _eczaneNobetOrduMerkezOptimization;
        ...
        public OrduMerkezOptimizationManager(
                    ...
                    IEczaneNobetOrduMerkezOptimization eczaneNobetOrduMerkezOptimization,
            ...
            )
        {
            ...
            _eczaneNobetOrduMerkezOptimization = eczaneNobetOrduMerkezOptimization;
        ...
        public EczaneNobetSonucModel EczaneNobetCozAktifiGuncelle(OrduMerkezDataModel data)
        {
            ...
            var yeniSonuclar = _eczaneNobetOrduMerkezOptimization.Solve(data);
        ...
        public EczaneNobetSonucModel EczaneNobetCozSonuclaraEkle(OrduMerkezDataModel data)
        {
            var yeniSonuclar = _eczaneNobetOrduMerkezOptimization.Solve(data);
        ...
        private OrduMerkezDataModel EczaneNobetDataModel(EczaneNobetDataModelParametre eczaneNobetDataModelParametre)
        {
            #region parametreler
            ...
            foreach (var nobetGrupGorevTip in nobetGrupGorevTipler)
            {
                ...
                var mesafeKriteriSon = mesafeKriterGrupBazli == 0 ? mesafeKriter : mesafeKriterGrupBazli;

                var mesafeKontrolEczanelerGruplu = _eczaneUzaklikMatrisService.GetMesafeKriterineGoreKontrolEdilecekEczaneGruplar(mesafeKriteriSon, eczaneMesafelerGrupBazli, eczaneNobetGruplarMesafeIcin)
            ...
            var nobetUstGrupKisitIstisnaGunGruplar = _nobetUstGrupKisitIstisnaGunGrupService.GetDetaylar(nobetUstGrupId);

            var dataModel = new OrduMerkezDataModel()
            {
                ...
                NobetUstGrupKisitIstisnaGunGruplar = nobetUstGrupKisitIstisnaGunGruplar
            };
