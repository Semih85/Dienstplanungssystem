...
{
    public class ManavgatOptimizationManager : IManavgatOptimizationService
    {
        #region ctor
        private IEczaneGrupService _eczaneGrupService;
        private IEczaneGrupTanimService _eczaneGrupTanimService;
        private IEczaneNobetManavgatOptimization _eczaneNobetManavgatOptimization;
        ...
        public ManavgatOptimizationManager(
                    ...
                    IEczaneNobetManavgatOptimization eczaneNobetManavgatOptimization,
            ...
            )
        {
            ...
            _eczaneNobetManavgatOptimization = eczaneNobetManavgatOptimization;
        ...
        public EczaneNobetSonucModel EczaneNobetCozAktifiGuncelle(ManavgatDataModel data)
        {
            ...
            var yeniSonuclar = _eczaneNobetManavgatOptimization.Solve(data);
        ...
        public EczaneNobetSonucModel EczaneNobetCozSonuclaraEkle(ManavgatDataModel data)
        {
            var yeniSonuclar = _eczaneNobetManavgatOptimization.Solve(data);
        ...
        private ManavgatDataModel EczaneNobetDataModel(EczaneNobetDataModelParametre eczaneNobetDataModelParametre)
        {
            ...
            var dataModel = new ManavgatDataModel()
            {
