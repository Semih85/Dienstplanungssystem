...
{
    public class CorumOptimizationManager : ICorumOptimizationService
    {
        #region ctor
        private IEczaneGrupService _eczaneGrupService;
        private IEczaneGrupTanimService _eczaneGrupTanimService;
        private IEczaneNobetCorumOptimization _eczaneNobetCorumOptimization;
        ...
        public CorumOptimizationManager(
                    IEczaneGrupService eczaneGrupService,
                    IEczaneGrupTanimService eczaneGrupTanimService,
                    IEczaneNobetCorumOptimization eczaneNobetCorumOptimization,
            ...
            )
        {
            ...
            _eczaneNobetCorumOptimization = eczaneNobetCorumOptimization;
        ...
        public EczaneNobetSonucModel EczaneNobetCozAktifiGuncelle(CorumDataModel data)
        {
            ...
            var yeniSonuclar = _eczaneNobetCorumOptimization.Solve(data);
        ...
        public EczaneNobetSonucModel EczaneNobetCozSonuclaraEkle(CorumDataModel data)
        {
            var yeniSonuclar = _eczaneNobetCorumOptimization.Solve(data);
        ...
        private CorumDataModel EczaneNobetDataModel(EczaneNobetDataModelParametre eczaneNobetDataModelParametre)
        {
            #region parametreler
            ...
            var mesafeler = _eczaneUzaklikMatrisService.GetDetaylar();
            ...
            var mesafeKriter = eczanelerArasiMesafeyiKoru.SagTarafDegeri;

            var eczaneMesafeler = mesafeler
                        .Where(w => w.Mesafe <= mesafeKriter).ToList();

            foreach (var eczaneMesafe in eczaneMesafeler)
            {
                var eczaneFrom = _eczaneService.GetDetayById(eczaneMesafe.EczaneIdFrom);
                var eczaneTo = _eczaneService.GetDetayById(eczaneMesafe.EczaneIdTo);

                var bakilanEczaneGrupTanimAdi = $"{eczaneMesafe.Id}, {eczaneFrom.EczaneAdi}-{eczaneTo.EczaneAdi} {eczaneMesafe.Mesafe} < {mesafeKriter}";

                mesafeKontrolEczaneler.Add(new EczaneGrupDetay
                {
                    EczaneGrupTanimId = eczaneMesafe.Id,
                    EczaneId = eczaneFrom.Id,
                    ...
                    NobetGrupId = 1,
                    EczaneAdi = eczaneFrom.EczaneAdi,
                    NobetGrupAdi = "çç",
                    EczaneNobetGrupId = eczaneFrom.Id,
                ...
                mesafeKontrolEczaneler.Add(new EczaneGrupDetay
                {
                    ...
                    EczaneGrupTanimTipId = 1,
                    NobetGrupId = 1,
                    EczaneAdi = eczaneTo.EczaneAdi,
                    NobetGrupAdi = "çç",
                    EczaneNobetGrupId = eczaneTo.Id,
                    AyniGunNobetTutabilecekEczaneSayisi = 1
                    //BirlikteNobetTutmaSayisi = item.BirlikteNobetTutmaSayisi
                });
            }
            ...
            foreach (var mesafe in mesafeler.Where(w => w.Mesafe > mesafeKriter))
            {
                ...
                {
                    EczaneAdi1 = eczaneFrom.EczaneAdi,
            ...
            var corumDataModel = new CorumDataModel()
            {
                ...
                IkiliEczaneler = ikiliEczanelerMesafe,//ikiliEczaneler,
