...
{
    public class KayseriOptimizationManager : IKayseriOptimizationService
    {
        #region ctor
        private IEczaneGrupService _eczaneGrupService;
        private IEczaneGrupTanimService _eczaneGrupTanimService;
        private IEczaneNobetKayseriOptimization _eczaneNobetKayseriOptimization;
        ...
        public KayseriOptimizationManager(
                    IEczaneGrupService eczaneGrupService,
                    IEczaneGrupTanimService eczaneGrupTanimService,
                    IEczaneNobetKayseriOptimization eczaneNobetKayseriOptimization,
            ...
            )
        {
            ...
            _eczaneNobetKayseriOptimization = eczaneNobetKayseriOptimization;
        ...
        public EczaneNobetSonucModel EczaneNobetCozAktifiGuncelle(KayseriDataModel data)
        {
            ...
            var yeniSonuclar = _eczaneNobetKayseriOptimization.Solve(data);
        ...
        public EczaneNobetSonucModel EczaneNobetCozSonuclaraEkle(KayseriDataModel data)
        {
            var yeniSonuclar = _eczaneNobetKayseriOptimization.Solve(data);
        ...
        private KayseriDataModel EczaneNobetDataModel(EczaneNobetDataModelParametre eczaneNobetDataModelParametre)
        {
            ...
            var dataModel = new KayseriDataModel()
            {
