...
{
    public class KirikhanOptimizationManager : IKirikhanOptimizationService
    {
        #region ctor
        private IEczaneGrupService _eczaneGrupService;
        private IEczaneGrupTanimService _eczaneGrupTanimService;
        private IEczaneNobetKirikhanOptimization _eczaneNobetKirikhanOptimization;
        ...
        public KirikhanOptimizationManager(
                    IEczaneGrupService eczaneGrupService,
                    IEczaneGrupTanimService eczaneGrupTanimService,
                    IEczaneNobetKirikhanOptimization eczaneNobetKirikhanOptimization,
            ...
            )
        {
            ...
            _eczaneNobetKirikhanOptimization = eczaneNobetKirikhanOptimization;
        ...
        public EczaneNobetSonucModel EczaneNobetCozSonuclaraEkle(KirikhanDataModel data)
        {
            var yeniSonuclar = _eczaneNobetKirikhanOptimization.Solve(data);
        ...
        private KirikhanDataModel EczaneNobetDataModel(EczaneNobetDataModelParametre eczaneNobetDataModelParametre)
        {
            ...
            var dataModel = new KirikhanDataModel()
            {
                ...
                TarihAraligi = tarihAralik,//takvimTumu
        ...
        private bool YazDonemiMi(DateTime baslangicTarihi, DateTime yazBaslangic, DateTime yazBitis)
        {
            return baslangicTarihi >= yazBaslangic && baslangicTarihi <= yazBitis;
        }
