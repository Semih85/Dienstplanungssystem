...
{
    public class Alanya2021OptimizationManager : IAlanya2021OptimizationService
    {
        #region ctor
        private IEczaneGrupService _eczaneGrupService;
        private IEczaneGrupTanimService _eczaneGrupTanimService;
        private IEczaneNobetAlanya2021OptimizationV2 _eczaneNobetAlanya2021Optimization;
        ...
        public Alanya2021OptimizationManager(
                    IEczaneGrupService eczaneGrupService,
                    IEczaneGrupTanimService eczaneGrupTanimService,
                    IEczaneNobetAlanya2021OptimizationV2 eczaneNobetAlanya2021Optimization,
            ...
            )
        {
            ...
            _eczaneNobetAlanya2021Optimization = eczaneNobetAlanya2021Optimization;
        ...
        public EczaneNobetSonucModel EczaneNobetCozAktifiGuncelle(Alanya2021DataModel data)
        {
            //var mevcutSonuclar = _eczaneNobetSonucAktifService.GetSonuclar2(data.NobetUstGrupId);
            var yeniSonuclar = _eczaneNobetAlanya2021Optimization.Solve(data);
        ...
        public EczaneNobetSonucModel EczaneNobetCozAktifiGuncelleIteratif(Alanya2021DataModel data)
        {
            var mevcutSonuclar = _eczaneNobetSonucAktifService.GetSonuclar2(data.NobetUstGrupId);
        ...
        //[TransactionScopeAspect]
        public EczaneNobetSonucModel EczaneNobetCozSonuclaraEkle(Alanya2021DataModel data)
        {
            var yeniSonuclar = _eczaneNobetAlanya2021Optimization.Solve(data);
        ...
        public EczaneNobetSonucModel EczaneNobetCozSonuclaraEkleYalin(Alanya2021DataModel data)
        {
            var yeniSonuclar = _eczaneNobetAlanya2021Optimization.Solve(data);
            _eczaneNobetSonucService.CokluEkle(yeniSonuclar.ResultModel);
        ...
        private Alanya2021DataModel EczaneNobetDataModel(EczaneNobetDataModelParametre eczaneNobetDataModelParametre)
        {
            #region parametreler
            ...
            var alanyaDataModel = new Alanya2021DataModel()
            {
