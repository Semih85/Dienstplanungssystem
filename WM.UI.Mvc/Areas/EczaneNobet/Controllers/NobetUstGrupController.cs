...
namespace WM.UI.Mvc.Areas.EczaneNobet.Controllers
{
    ...
    public class NobetUstGrupController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Adi,EczaneOdaId,BaslangicTarihi,BitisTarihi,Aciklama")] NobetUstGrup nobetUstGrup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Adi,EczaneOdaId,BaslangicTarihi,BitisTarihi,Aciklama")] NobetUstGrup nobetUstGrup)
        {
            if (ModelState.IsValid)
            {
