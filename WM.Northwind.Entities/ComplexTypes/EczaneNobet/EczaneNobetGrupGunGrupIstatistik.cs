...
{
    public class EczaneNobetGrupGunGrupIstatistik : IComplexType
    {
        ...
        public DateTime SonrakiMuhtemelNobetTarihi { get; set; }
        ...
        public DateTime SonrakiIlkNobetTarihi { get; set; }
    }
}
